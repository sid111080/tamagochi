...
class PetSpecies {
  ...
  static const List<PetSpecies> all = [
    ...
    PetSpecies(
      ...
      defaultName: 'Чарли',
      // Двух вариантов дракона нет, поэтому полный дракон 🐉 показываем
      // уже с 2-го уровня (стадия «Ребёнок»): мордочка → дракон.
      // Иначе на 1→2 рост был бы только размером — и тот незаметен.
      stageEmojis: ['🐲', '🐉', '🐉', '🐉'],
